...
public class StudentActivity extends AppCompatActivity implements BeaconConsumer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("안녕하세요. " + studentName + "님.");

        GetList listTask = new GetList();
        listTask.execute(Integer.toString(studentID));
        ...
        if(lectureID.isEmpty()) {
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView parent, View v, int position, long id) {
                    int index = (int) parent.getItemIdAtPosition(position) + 1;
                    Toast.makeText(getApplicationContext(), String.format("%d번째 선택", index), Toast.LENGTH_SHORT).show();
                }
            });
        }
    ...
    private class GetList extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(StudentActivity.this, "Please Wait", null, true, true);
        }
        ...
        protected void onPostExecute(String result) {
            ...
            if (result == null){
                ...
                mJsonString = result;
                if(mJsonString.equals("수강하는 수업이 없습니다.") || mJsonString.equals("정보를 받아오는데 실패했습니다.")){
        ...
        protected String doInBackground(String... params) {
            ...
            String serverURL = "http://172.30.1.24/getlist.php";
